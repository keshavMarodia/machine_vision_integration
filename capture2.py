...
def Final_Merge():
    IMG1 = cv2.imread(r"college-project\src\components\Delete\1.jpg")
    img1_rot = cv2.rotate(IMG1, cv2.ROTATE_90_CLOCKWISE)

    IMG2 = cv2.imread(r"college-project\src\components\Delete\2.jpg")
    ...
    cv2.imwrite(r"college-project\src\components\Delete\concat_Final.jpg", im_h1_rot)
